...
PAYPAL_RECEIVER_EMAIL = 'a_latreche@estin.dz'  # where cash is paid into
PAYPAL_TEST = True

EMAIL_HOST = 'smtp.gmail.com'
EMAIL_HOST_USER = 'abdellahlatreche1@gmail.com'
EMAIL_HOST_PASSWORD = 'dpbgrehnfvrbbrbh'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
...
CELERY_BROKER_CONNECTION_RETRY = True  # Deprecated, but retains behavior for Celery < 6.0
CELERY_BROKER_CONNECTION_RETRY_ON_STARTUP = True  # New option introduced in Celery 6.0
# Celery beat settings
CELERY_BEAT_SCHEDULE = {
    'send-drop-off-notifications': {
        'task': 'car_reservation.tasks.send_drop_off_notification_task',
        'schedule': timedelta(minutes=2),  # Schedule to run every hour(now for two minutes just so I don't have to wait for 1 hour)
    },
    'send-rating-notifications': {
        'task': 'car_reservation.tasks.send_rating_notification_task',
